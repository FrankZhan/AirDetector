...
//                        + mApPassword);
                    ...
                    if (result != null) {
                        ...
                        if (timeout < 0) {
                            ...
                            try{
                                ...
                                String bssid = jsonResult.getString("BSSID");
                                InetAddress inetAddress = InetAddress.getByName(jsonResult.getString("IP"));
                                __putEsptouchResult(true, bssid, inetAddress);
                            }catch(Exception e) {
    ...
    public List<IEsptouchResult> executeForResults(int expectTaskResultCount)
        ...
        // listen the esptouch result asyn, 使用自定义的不带参数的函数
...
//    //监听用户发回来的ACK
//    private void __listenACK(){
//        mTask = new Thread() {
//            public void run() {
//                if (__IEsptouchTask.DEBUG) {
//                    Log.d(TAG, "__listenACK() start");
//                }
//                long startTimestamp = System.currentTimeMillis();
//                String result;
//
...
//    }
//    //发送用户数据
//    public boolean executeSendAppData(String jsonData, String hostName){
//
//
//        isACK = false;
...
//            mSocketClient.sendStrData(jsonData,
//                    hostName,
//                    mParameter.getTargetPort(),
//                    mParameter.getIntervalGuideCodeMillisecond());
//            if(isACK){
